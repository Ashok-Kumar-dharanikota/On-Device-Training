...
public class CameraFragment extends Fragment {
  ...
  String MODEL_NAME = "custom_model";
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
    ...
    chipGroup.setOnCheckedChangeListener((group, checkedId) -> {
      if (checkedId == R.id.capture_mode_chip) {
        ...
        File modelPath = getActivity().getApplicationContext().getFilesDir();
        ...
        if (modelFile.exists()) {
          ...
          //Toast.makeText(getActivity().getApplicationContext(), "Model loaded.", Toast.LENGTH_SHORT).show();
        }
        ...
        //Toast.makeText(getActivity().getApplicationContext(), "Model saved.", Toast.LENGTH_SHORT).show();
      }
    });
